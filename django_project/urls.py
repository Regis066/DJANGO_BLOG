...
urlpatterns = [
    ...
    path("password-reset/confirm/<uid64>/<token>", auth_views.PasswordResetConfirmView.as_view(template_name = "user/password_reset_confirm.html") , name='password-reset-confirm'),
